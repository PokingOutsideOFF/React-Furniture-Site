      ...
      <div className="col-lg-6 mx-auto">
        <div className="card border-primary shadow my-2">
          ...
          <div className="card-body border-bottom border-primary">
            ...
            <div className="mb-3 row">
              <div className="col-lg-4 col-form-label">Email</div>
              <div className="col-lg-8">
                <input
                  type="text"
                  id="email"
            ...
            <a href="#" style={{textDecoration: "none"}} className="form-text text-primary">Already a user? Log in</a>
          </div>
          <div className="card-footer border-bottom border-primary text-center">
