...
function Checkout() {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch(`http://localhost:5000/orders?userId=${user.currentUserId}`, {
        method: "GET",
      });
  ...
  return (
    <div style={{ paddingTop: "60px" }}>
      <div className="banner-container w-100">
        <img src="./assets/img/checkout.png" alt="Background Image" className="banner-image" />
        <div className="checkout-title-container">
          <div className="checkout-title">Checkout</div>
        </div>
        <div className="breadcrumb">
          <div className="breadcrumb-home">
            <a href="../home.html" style={{ color: "black", textDecoration: "none" }}>Home</a>
          </div>
          <div className="breadcrumb-current">Checkout</div>
          <div className="breadcrumb-arrow">
            <img src="./assets/img/dashicons_arrow-down-alt2.png" alt="Icon" className="arrow-icon" />
          </div>
        </div>
      </div>
        ...
        <div className="checkout-content">
          <div className="billing-details">
            ...
            <div className="input-group">
              ...
              <input id="street-address" type="text" className="input" required />
            </div>
            <div className="input-group">
            ...
            <div className="input-group">
              ...
              <input id="province" type="text" className="input" placeholder="Western Province" required />
            </div>
            <div className="input-group">
              <label htmlFor="phone" className="label">Phone</label>
              <input id="phone" type="text" className="input" pattern="[\\+]{1}[0-9]{2}-[0-9]{10}" placeholder="+91-1234567890" required />
            </div>
            <div className="input-group">
              <label htmlFor="email" className="label">Email address</label>
              <input id="email" type="email" className="input" placeholder="abc@xyz.com" required />
            </div>
          ...
          <div className="order-summary">
            ...
            <div className="order-summary">
                  ...
                  <tbody>
                    {cart.map((p) => (
                      <tr className="text-left" key={p.id}>
                        <td><h2></h2>
                          <span className="product-name">{p.product ? p.product.productName : "N/A"}</span>
                        </td>
                        <td>
                          <span className="product-price">₹{p.product ? p.product.price : "N/A"}</span>
                        </td>
                      </tr>
                    ))}
                  </tbody>
              ...
              <div className="order-subtotal">
                ...
                <span className="subtotal-price">₹{totalAmount.toFixed(2)}</span>
              </div>
              <div className="order-subtotal">
              ...
              <button className="place-order-button" value="Submit" type="submit">Place order</button>
            </div>
          </div>
        </div>
      </form>
      ...
      <div className="features-container">
        <div className="feature-item">
          <img src="./assets/img/Group.png" alt="High Quality" className="feature-icon" />
          <h3>High Quality</h3>
          <p>crafted from top materials</p>
        </div>
        <div className="feature-item">
          <img src="./assets/img/guarantee.png" alt="Warranty Protection" className="feature-icon" />
          <h3>Warranty Protection</h3>
          <p>Over 2 years</p>
        </div>
        <div className="feature-item">
          <img src="./assets/img/shipping.png" alt="Free Shipping" className="feature-icon" />
          <h3>Free Shipping</h3>
          <p>Order over 150 $</p>
        </div>
        <div className="feature-item">
          <img src="./assets/img/customer-support.png" alt="24/7 Support" className="feature-icon" />
          <h3>24 / 7 Support</h3>
